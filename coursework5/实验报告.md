...
![showSD](https://github.com/SpursLipu/Embedded-software-development-technology-and-tools-/blob/master/coursework5/images/finish.png)

把SD卡挂接到ubuntu虚拟机系统中。

![mountSD](https://github.com/SpursLipu/Embedded-software-development-technology-and-tools-/blob/master/coursework5/images/finish.png)

安装内核模块：sudo make ARCH=arm INSTALL_MOD_PATH=/mnt/ext4 modules_install

![installSD](https://github.com/SpursLipu/Embedded-software-development-technology-and-tools-/blob/master/coursework5/images/finish.png)

向已经写入树莓派系统的内存卡，替换系统的内核镜像、设备树，以及内核模块的安装。最后取消挂载。

![copySD](https://github.com/SpursLipu/Embedded-software-development-technology-and-tools-/blob/master/coursework5/images/finish.png)

从电脑上拔出SD卡，重新插回树莓派，重新启动树莓派，用指令uname查看树莓派内核版本。结果显示内核以从原来的4.14.71更新至4.19.120.

![newVersion](https://github.com/SpursLipu/Embedded-software-development-technology-and-tools-/blob/master/coursework5/images/finish.png)
...
![kernel_config](https://github.com/SpursLipu/Embedded-software-development-technology-and-tools-/blob/master/coursework5/images/finish.png)
...
```
我们小组以构建智能家居监控系统终端为应用目标，进行系统内核的裁剪。该终端基于树莓派，软件平台为linux，编程环境有C和python；需要支持的设备主要有摄像头、温度传感器和湿度传感器；网络连接主要通过wifi，涉及TCP/IP协议。我们的裁剪主要分为4部分：
```
① General setup。
...
![cut_version](https://github.com/SpursLipu/Embedded-software-development-technology-and-tools-/blob/master/coursework5/images/finish.png)
...
![lsmod](https://github.com/SpursLipu/Embedded-software-development-technology-and-tools-/blob/master/coursework5/images/finish.png)

卸载已安装模块fixed：

![rmmod1](https://github.com/SpursLipu/Embedded-software-development-technology-and-tools-/blob/master/coursework5/images/finish.png)

重新安装刚卸载的模块fixed，在安装之前可以通过infomod fixed指令获得该模块所在路径：

获取路径：

![infomod](https://github.com/SpursLipu/Embedded-software-development-technology-and-tools-/blob/master/coursework5/images/finish.png)

安装fixed：

![insmod1](https://github.com/SpursLipu/Embedded-software-development-technology-and-tools-/blob/master/coursework5/images/finish.png)

同样的方法测试卸载然后安装joydev模块：

卸载：

![rmmod2](https://github.com/SpursLipu/Embedded-software-development-technology-and-tools-/blob/master/coursework5/images/finish.png)

安装：

![insmod2](https://github.com/SpursLipu/Embedded-software-development-technology-and-tools-/blob/master/coursework5/images/finish.png)
...
![showFS](https://github.com/SpursLipu/Embedded-software-development-technology-and-tools-/blob/master/coursework5/images/finish.png)
...
![fdisk success](https://github.com/SpursLipu/Embedded-software-development-technology-and-tools-/blob/master/coursework5/images/finish.png)

第二步，用mkfs指令将分区格式化为所需要的格式：

![mkfs success](https://github.com/SpursLipu/Embedded-software-development-technology-and-tools-/blob/master/coursework5/images/finish.png)

第三步，用mount指令将格式化好的分区挂载到树莓派上某挂载点。经过测试可以通过挂载点向U盘进行文件传输等操作。还通过gparted软件查看到U盘已被格式化为ext2。

![mount success](https://github.com/SpursLipu/Embedded-software-development-technology-and-tools-/blob/master/coursework5/images/finish.png)

![gparted](https://github.com/SpursLipu/Embedded-software-development-technology-and-tools-/blob/master/coursework5/images/finish.png)
