...
![makedev](https://github.com/SpursLipu/Embedded-software-development-technology-and-tools-/blob/master/coursework6/images/driver_compile.png)

5、加载卸载驱动

![insmod](https://github.com/SpursLipu/Embedded-software-development-technology-and-tools-/blob/master/coursework6/images/driver_compile.png)

![rmmod](https://github.com/SpursLipu/Embedded-software-development-technology-and-tools-/blob/master/coursework6/images/driver_compile.png)
...
![test_result](https://github.com/SpursLipu/Embedded-software-development-technology-and-tools-/blob/master/coursework6/images/test.png)

7、创建多个scull驱动

![makesculls](https://github.com/SpursLipu/Embedded-software-development-technology-and-tools-/blob/master/coursework6/images/test.png)
...
![readscull](https://github.com/SpursLipu/Embedded-software-development-technology-and-tools-/blob/master/coursework6/images/file3.png)

数据写入结果：

![data1](https://github.com/SpursLipu/Embedded-software-development-technology-and-tools-/blob/master/coursework6/images/file3.png)

![data2](https://github.com/SpursLipu/Embedded-software-development-technology-and-tools-/blob/master/coursework6/images/file3.png)
...
PC（linux）客户端与服务端通信展示。客户端可以向服务端发送获取数据指令，系统目前设定有四个：获取scull1产生的最新数据，获取scull1产生的历史十条数据，获取scull1产生的最新数据，获取scull1产生的历史十条数据。如果输入不是正确的指令会有错误提示。

![final1](https://github.com/SpursLipu/Embedded-software-development-technology-and-tools-/blob/master/coursework6/images/multiprocess.png)

![final2](https://github.com/SpursLipu/Embedded-software-development-technology-and-tools-/blob/master/coursework6/images/multiprocess.png)
